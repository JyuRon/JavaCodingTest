...
public class Section10_MaxHeap {
    ...
    public Section10_MaxHeap(Integer data){
    ...
    public boolean move_down(int popIdx){
        ...
        // 자식 노드가 모두 존재하는 경우 자식노드 중 가능 큰 노드를 선택한다
    ...
    public static void main(String[] args) {
        Section10_MaxHeap heapTest = new Section10_MaxHeap(15);
        heapTest.insert(10);
        heapTest.insert(8);
        heapTest.insert(5);
        heapTest.insert(4);
